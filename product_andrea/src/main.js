...
async function iniciarTienda() {
    myStore = new Store(1, 'Almacén de ACME');
    await myStore.init(); // ahora sí podés usar await sin problema
    console.log(myStore.categories); // los datos ya están cargados
    myStore.delCategory(1);
...
//     console.error(err)
// }
// lo comento para que cada vez que cargue la página no se añadan
// try {
